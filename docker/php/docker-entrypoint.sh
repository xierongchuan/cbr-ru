...
# Синхронизация курсов валют при запуске контейнера
echo "🔄 Первоначальная синхронизация всех курсов валют с ЦБ РФ..."
php artisan cbr:fetch-all-rates || echo "⚠️ Синхронизация всех валют не удалась."

echo "🔄 Синхронизация настроенных курсов валют с ЦБ РФ..."
php artisan cbr:fetch-rates || echo "⚠️ Синхронизация не удалась, но контейнер продолжает работу."
