...
# Синхронизация всех курсов валют при запуске (вчера + сегодня + завтра если доступно)
echo "🔄 Загрузка всех курсов валют (вчера + сегодня + завтра)..."
php artisan cbr:fetch-rates --date=both --all --tomorrow || echo "⚠️ Загрузка курсов не удалась."
